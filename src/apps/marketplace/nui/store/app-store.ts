...
export const useMarketplaceStore = defineStore('marketplace', () => {
  ...
  const addListing = (data: NewListingData) => {
    const newListing: Listing = {
      ...
      price: data.price,
      imageUrls: ['https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/200x150/e0e0e0/777?text=New+Post'],
      timestamp: 'Just now',
      isOwner: true,
    };
